...
async function readPartsJson(filename) {
  try {
    ...
    console.error('❗ JSON 파일 내용이 배열이 아닙니다:', json);
    return [];
  } catch (err) {
...
async function crawlAll() {
  await crawlAndSave('./frontend/public/data/cpuDB.json', './frontend/public/data/cpu_danawa_price.json');
  await crawlAndSave('./frontend/public/data/gpuDB.json', './frontend/public/data/gpu_danawa_price.json');
}
